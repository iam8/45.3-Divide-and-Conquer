...
describe("#findFloor", function(){
    it("returns the floor or -1", function(){
        ...
        expect(findFloor([1, 2, 8, 10, 10, 12, 19], 11)).toBe(10);
        expect(findFloor([1, 2, 8, 10, 10, 12, 19], 10)).toBe(10);
        expect(findFloor([1], 3)).toBe(1);
        expect(findFloor([7], 1)).toBe(-1);
        expect(findFloor([], 1)).toBe(-1);
    })
})
